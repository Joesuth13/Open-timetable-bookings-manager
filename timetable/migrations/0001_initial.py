    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ParticipantID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='timetable.participant')),
            ],
            options={
                'verbose_name': 'user',
